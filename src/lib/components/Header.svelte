<header class="flex h-20 items-center bg-[#313131] sm:px-0">
	<nav class="mx-auto flex w-full justify-between">
		<div class="flex h-20 items-center sm:px-20 sm:pl-20">
			<span class="absolute left-7 hidden h-5 w-5 rounded-full bg-orange-600 sm:block" />
			<a href="/">
				<button
					class="focused px-4 py-3 font-mukta text-xs font-light tracking-widest text-white/70"
				>
					BLOG HOME
				</button>
			</a>
